...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1"><i class="bi bi-pencil me-2"></i>Modifier le Slide</h4>
            <p class="text-muted mb-0">{{ $heroSlide->title }}</p>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('subtitle') is-invalid @enderror" 
                                      id="subtitle" name="subtitle" rows="2">{{ old('subtitle', $heroSlide->subtitle) }}</textarea>
                            @error('subtitle')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('button_text') is-invalid @enderror" 
                                           ...
                                           value="{{ old('button_text', $heroSlide->button_text) }}" required>
                                    @error('button_text')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('button_link') is-invalid @enderror" 
                                           ...
                                           value="{{ old('button_link', $heroSlide->button_link) }}" required>
                                    @error('button_link')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="card-body">
                        @if($heroSlide->image)
                            <div class="mb-3 text-center">
                                <img src="{{ asset('storage/' . $heroSlide->image) }}" 
                                     alt="{{ $heroSlide->title }}" 
                        ...
                        @endif
                        <div class="mb-3">
                            <label for="image" class="form-label">{{ $heroSlide->image ? 'Changer l\'image' : 'Ajouter une image' }}</label>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="color" class="form-control form-control-color" 
                                       id="bg_color_picker" value="{{ Str::startsWith($heroSlide->background_color, '#') ? $heroSlide->background_color : '#1a1a2e' }}" 
                                ...
                                <input type="text" class="form-control @error('background_color') is-invalid @enderror" 
                                       ...
                                       value="{{ old('background_color', $heroSlide->background_color) }}">
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="color" class="form-control form-control-color" 
                                       id="text_color_picker" value="{{ $heroSlide->text_color }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('order') is-invalid @enderror" 
                                   id="order" name="order" value="{{ old('order', $heroSlide->order) }}" min="0">
                        </div>

                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="status" name="status" 
                                       {{ old('status', $heroSlide->status) ? 'checked' : '' }}>
